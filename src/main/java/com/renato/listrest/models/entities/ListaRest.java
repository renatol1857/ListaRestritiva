...
@Setter
@NoArgsConstructor
public class ListaRest implements Serializable {
	@Transient
	...
	public ListaRest(String fullfone) {
	...
	public ListaRest(String ddi, String ddd, String fone) {
		this.ddi = ddi;
		this.ddd = ddd;
		this.fone = fone;
